            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url('vote_a/dashboard') ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('vote_a/add_mahasiswa') ?>"><i class="fa fa-user-plus fa-fw"></i> Add Mahasiswa</a>
                        </li>
                        <li>
                          <a href="#"><i class="fa fa-table fa-fw"></i> Data Mahasiswa<span class="fa arrow"></span></a>
                          <ul class="nav nav-second-level">
                              <li>
                                  <a href="<?php echo base_url('vote_a/teknik_informatika') ?>">Teknik Informatika</a>
                              </li>
                              <li>
                                  <a href="<?php echo base_url('vote_a/sistem_informasi') ?>">Sistem Informasi</a>
                              </li>
                          </ul>
                        </li>
                    </ul>
